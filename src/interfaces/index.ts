...
export type { default as IProductLineGroup } from './product-line-group';
export type { default as IProductLineGroupData } from './product-line-group-data';
export type { default as IProductLineGroupOption } from './product-line-group-option';
...
export type { default as ISelectOption } from './select-option';
